...
class ReplInterpreter(
    ...
    fun eval(line: String): LineResult {
        ...
        val state = GenerationState(psiFile.project, ClassBuilderFactories.BINARIES, analyzerEngine.module, analyzerEngine.trace.bindingContext, listOf(psiFile), configuration)
